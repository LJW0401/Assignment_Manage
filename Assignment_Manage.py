...
class Assignment_Manage:
    ...
    def Button_Send_Email(self):
        ...
        userName_AuthCode = 'hbjsloiuknxnjejb'#授权码
        

        res=tkinter.messagebox.askyesno('确定是否发送作业','若确定发送点击"是"，否则点击"否"')
        if not res:
            return
        ...
        WrongNames=[]
        for i,FilePath in enumerate(os.listdir(dir)):
            ...
            # 正文
            content=f'这是{FolderName}的作业，请查收。'
